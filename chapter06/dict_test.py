...
的每项信息都打印出来。
"""
friend = {'frist_name':'David','last_name':'Green','age':18,'city':'shanghai'}
print(friend)
"""
...
"""
favorite_number = {'Lily':4,'Chenming':12,'Yange':13}
...
"""
"""
-4 词汇表2 ：既然你知道了如何遍历字典，现在请整理你为完成练习6-3而编写的代码，将其中的一系列print 语句替换为一个遍历字典中的键和值的循环。确定该
...
"""
Timi = {'type':'dog','owner':'Lily'}
Tommy = {'type':'cat','owner':'David'}
pets=[Timi,Tommy]
for pet in pets:
    print(pet)
    pet_type = pet['type']
...
6-12 扩展扩展 ：本章的示例足够复杂，可以以很多方式进行扩展了。请对本章的一个示例进行扩展：添加键和值、调整程序要解决的问题或改进输出的格式。
"""